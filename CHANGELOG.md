...
Developer facing:
 ...
 - Add utility script to add predecessor event to `ONE_TO_ONE` Matrix rooms (fix duplication in room list), https://gitlab.com/gitterHQ/webapp/-/merge_requests/2409
