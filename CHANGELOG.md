...
Developer facing:
 ...
 - Update `scripts/utils/ensure-existing-bridged-matrix-rooms-up-to-date.js` to run fast and concurrently (and other minor fixes), https://gitlab.com/gitterHQ/webapp/-/merge_requests/2369, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2371, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2372, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2379, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2380, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2382, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2384, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2387, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2389, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2390, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2393, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2394
 - Add utility script to backfill room membership to Matrix, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2331, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2373, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2374, https://gitlab.com/gitterHQ/webapp/-/merge_requests/2375
...
Developer facing:
 ...
 - Fix configure secrets readme reference, https://gitlab.com/gitterHQ/webapp/-/merge_requests/1815
...
Developer facing:
 ...
 - Add `GL_PROJECT` to the linkPath validation for room creation, https://gitlab.com/gitterHQ/webapp/-/merge_requests/1808
...
Developer facing:
 ...
 - Add scripts to aggregate Gitter community data into reports (stats), https://gitlab.com/gitterHQ/webapp/merge_requests/1668
...
# 20.6.0 - 2019-10-18
 ...
 - Unread notifications for child messages, https://gitlab.com/gitterHQ/webapp/merge_requests/1606
...
# 19.7.0 - 2018-06-27
 ...
 - Ensure you can admin the auto-selected community before populating create room modal, https://gitlab.com/gitterHQ/webapp/merge_requests/1117

Developer facing:

 - Update to `gitter-realtime-client@1.7.0` which has an updated Halley (smart WebSocket client) ([more context](https://gitlab.com/gitterHQ/webapp/issues/1937#solution)), https://gitlab.com/gitterHQ/webapp/merge_requests/1190
...
Developer facing:
 ...
 - Add `scripts/utils/delete-group.js` util script to delete a group/community, https://gitlab.com/gitterHQ/webapp/merge_requests/1166
...
# 19.3.0 - 2018-06-07
 ...
 - Update code syntax highlighting to have better visual contrast,
    - Thanks to [@TallTed](https://gitlab.com/TallTed) for the contribution, https://gitlab.com/gitterHQ/webapp/merge_requests/1174
 - Fix "Sign in with GitLab" not working -> "Failed to fetch user profile", https://gitlab.com/gitterHQ/webapp/merge_requests/1177

Developer facing:

 - Technical debt: Move `server/services/room-service.js` to `gitter-web-rooms` module, https://gitlab.com/gitterHQ/webapp/merge_requests/1165
 ...
 - Update utility script docs to be more copy-pasta friendly, https://gitlab.com/gitterHQ/webapp/merge_requests/1173
 - Fix `skip` parameter in the room search API endpoint `/v1/rooms?q=foo&skip=15&limit=3`
    - Thanks to [@nsuchy](https://gitlab.com/nsuchy) for the contribution, https://gitlab.com/gitterHQ/webapp/merge_requests/1175
...
Developer facing:
 ...
 - Add developer FAQ, https://gitlab.com/gitterHQ/webapp/merge_requests/1163
...
Developer facing:
 ...
 - Update `scripts/utils/auto-remove-from-room.js` to be robust against a room not existing, https://gitlab.com/gitterHQ/webapp/merge_requests/1153
...
## 19.0.0 - 2018-05-09
 ...
 - Deploy to beta/production via GitLab CI
     - https://gitlab.com/gitterHQ/webapp/merge_requests/1064, https://gitlab.com/gitterHQ/webapp/merge_requests/1081, https://gitlab.com/gitterHQ/webapp/merge_requests/1099, https://gitlab.com/gitterHQ/webapp/merge_requests/1102, https://gitlab.com/gitterHQ/webapp/merge_requests/1125
 - Add `:slight_smile:` 🙂 emoji
    - Thanks to [@porsager](https://gitlab.com/porsager) for the contribution, https://gitlab.com/gitterHQ/webapp/merge_requests/1097
 - Disable emoticons like :) turning into emojis
    - Thanks to [@asmeurer](https://gitlab.com/asmeurer) for the contribution, https://gitlab.com/gitterHQ/webapp/merge_requests/1115
 - Fix "Raise an Issue" linking to [deprecated GitHub issue repo](https://github.com/gitterHQ/gitter) instead of [GitLab](https://gitlab.com/gitterHQ/webapp)
    - Thanks to [@dregad](https://gitlab.com/dregad) for the contribution, https://gitlab.com/gitterHQ/webapp/merge_requests/1101
 - Add ability to revoke OAuth clients, https://gitlab.com/gitterHQ/webapp/merge_requests/1071
    - Avoid redirect loop even with forced token authentication, https://gitlab.com/gitterHQ/webapp/merge_requests/1132
 - Fix welcome message error thrown when signing in and auto-joining a room via Sidecar, https://gitlab.com/gitterHQ/webapp/merge_requests/1085
 - Fix "Repo Info" tab text-color with the dark theme enabled in the right-sidebar, https://gitlab.com/gitterHQ/webapp/merge_requests/1083
 - Update repo conflict room creation validation message to be more actionable, https://gitlab.com/gitterHQ/webapp/merge_requests/1118
 - Update to `readme-badger@0.3.0` which adds smarter markdown badge insertion (insert alongside other badges)
    - Thanks to [@chinesedfan](https://gitlab.com/chinesedfan) for the contribution, https://gitlab.com/gitterHQ/webapp/merge_requests/1116 (see https://github.com/gitterHQ/readme-badger/pull/44 for the contribution in the `readme-badger` repo)
 - Remove "Your organisations" section from the bottom of the conversation list, https://gitlab.com/gitterHQ/webapp/merge_requests/1123
 - Fix null-pointer exception (NPE) issue with the issue decorator in the Safari desktop app, https://gitlab.com/gitterHQ/webapp/merge_requests/1134
 - Fix new messages not appearing in chat list, https://gitlab.com/gitterHQ/webapp/merge_requests/1146

Developer facing:

 - Add `package-lock.json` for consistent and stable dependencies. Document Node.js v6 and npm v5 requirements, https://gitlab.com/gitterHQ/webapp/merge_requests/1103
 - Remove anonymous token password. `tokens__anonymousPassword` is now needed in your `.env` file, https://gitlab.com/gitterHQ/webapp/merge_requests/1088
 - Add support for Docker Compose, Docker for Mac, Docker for Windows instead of Docker Toolbox, https://gitlab.com/gitterHQ/webapp/merge_requests/1084
 - Initially build CSS fileset when using watch task, https://gitlab.com/gitterHQ/webapp/merge_requests/1075
 - Re-enable `unhandledrejection` Sentry logging and fix `undefined` messages, https://gitlab.com/gitterHQ/webapp/merge_requests/1131
    - Updated Sentry Raven.js [`raven-js@3.24.2`(https://www.npmjs.com/package/raven-js), https://gitlab.com/gitterHQ/webapp/merge_requests/1130
 - Add docs for running on Windows, https://gitlab.com/gitterHQ/webapp/merge_requests/1074
 - Restructure and add docs to help get started touching production, https://gitlab.com/gitterHQ/webapp/merge_requests/1107
    - Add more docs about fixing Mongo -> Elasticsearch rivers in production, https://gitlab.com/gitterHQ/webapp/merge_requests/1108
    - Add docs on how to use `deploy-tools/service-tree` and moving projects to GitLab, https://gitlab.com/gitterHQ/webapp/merge_requests/1121
 - Friendly iOS notification missing config errors in logs, https://gitlab.com/gitterHQ/webapp/merge_requests/1072
 - Fix number based usernames(like `000123`) being passed incorrectly to utility scripts CLI argv, https://gitlab.com/gitterHQ/webapp/merge_requests/1089
 - Update to `@gitterhq/styleguide@2.0.0` to fix the static server(on port 5001) not starting up in the local dev environment, https://gitlab.com/gitterHQ/webapp/merge_requests/1119
 - Add utility script to send fake unread notification email, `scripts/utils/send-unread-notification-email.js`, https://gitlab.com/gitterHQ/webapp/merge_requests/1135
 - Update `scripts/utils/rename-group.js` to account for `homeUri`, https://gitlab.com/gitterHQ/webapp/merge_requests/1133
 ...
 - Update to `bluebird@3.5.1`, https://gitlab.com/gitterHQ/webapp/merge_requests/1139
 - Update to `@gitterhq/env@0.36.0` to fix Sentry sending errors, https://gitlab.com/gitterHQ/webapp/merge_requests/1148
